...
const contractAddress = "0xf563833FdB9aC0D4eCC929f8A49Dbc7bE8385429";
    ...
    ethereum
      ...
      .then(() => {
        ...
        document.getElementById("mint").addEventListener("click", function () {
          ...
          contract.safeMint(to, quantity, interval)
            .then((tx) => {
              console.log("Transaction occurred: ", tx.hash);
              return tx.wait().then(() => {
        ...
        document.getElementById("checkTimestamp").addEventListener("click", function () {
            contract.checkTimeStamp()
              .then((timestamp) => {
                console.log("Timestamp: ", timestamp);
                // Display the timestamp on the webpage or perform any other actions
              })
              .catch((err) => console.error(err.message));
          });
          

        // Add other event listeners and contract interactions here
        // ...
